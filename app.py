        ...
        try :
            ...
            if 'imposta' not in RequestJson['query'].values() and 'stato' not in RequestJson['query'].values():
                ...
                if 'value' not in RequestJson['statoswitch'].keys():
                    value = RequestJson['numeri']['value']
                    obj = RequestJson['temperatura']['value']
                ...
                if 'value' in RequestJson['tiposensore'].keys():
                    if 'temperatura' in RequestJson['tiposensore']['value']:
                        ...
                        print({"object": "temperatura", "value": "temperatura", "query": "?"})
                        jsonRequest = {"object": "temperatura", "value": "temperatura", "query": "?"}
                        # {"object":"humidity","query":"?"}
                    else:
                        print('What is the current humidity?')
                        # {"object":"humidity","query":"?"}
                        print({"object": "umidita", "value": "umidita", "query": "?"})
                        jsonRequest = {"object": "umidita", "value": "umidita", "query": "?"}
                else:
